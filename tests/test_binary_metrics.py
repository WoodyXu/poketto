...
class TestBinaryMetrics(unittest.TestCase):
    def test_invalid_input(self):
        self.assertRaises(ValueError, bin.BinaryMetrics, None, [1])
        self.assertRaises(ValueError, bin.BinaryMetrics, [1], None)
        self.assertRaises(ValueError, bin.BinaryMetrics, [1, 0], [0.4, 0.3, 0.1])
        self.assertRaises(ValueError, bin.BinaryMetrics, [1, 0, 2], [0.4, 0.3, 0.1])
        self.assertRaises(ValueError, bin.BinaryMetrics, [1, 0, 1], [1.2, 0.3, 0.1])
